...
def list_to_col(df1, col_name, lst):
    """
    Takes a list, column name, and df, converts the list to a pandas series and adds it to the 
    df under the column name provided.
...
def split_dates(df, col_name):
    """
    takes a df and column name that is in MM/DD/YYYY format and splits it into a month, day and year column.
